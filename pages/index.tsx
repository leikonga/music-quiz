...
const Home: NextPage = () => (
  <>
    <div className="flex flex-col space-y-4">
      ...
      <p>
        Please note that you have to be invited by the owner of this application
        in order to be able to play music quiz.
        <br /> If you are already invited, please click the button below to
        start playing.
      </p>
